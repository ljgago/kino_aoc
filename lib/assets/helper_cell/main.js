  ...
  const BaseSelect = {
    ...
    <div v-bind:class="[inline ? 'inline-field' : 'field', grow ? 'grow' : '']">
      ...
      <select
        ...
        v-bind:class="[selectClass, { unavailable: !available(modelValue, options), required: !modelValue && required }]"
      >
  ...
  const BaseInput = {
    ...
    <div :class="[inline ? 'inline-field' : 'field', grow ? 'grow' : '']">
      ...
      <input
        ...
        v-bind="$attrs"
        :class="[inputClass, number ? 'input-number' : '', { required: !modelValue && required }, emptyClass]"
      >
    </div>
    `,
  };
